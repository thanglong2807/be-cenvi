...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Email đăng nhập (*)").fill("acbc@gmail.com")
    ...
    page.get_by_role("textbox", name="Họ và tên (*)").fill("Te")
    page.get_by_role("textbox", name="Họ và tên (*)").press("Shift+ArrowLeft")
    page.get_by_role("textbox", name="Họ và tên (*)").fill("Té")
    page.get_by_role("textbox", name="Họ và tên (*)").press("Shift+ArrowLeft")
    page.get_by_role("textbox", name="Họ và tên (*)").fill("Tet")
    ...
    page.locator("notifier-notification").click()
    page.close()
